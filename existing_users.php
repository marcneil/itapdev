...
<html>
    ...
    <body class="w3-sand">
       ...
       <nav>
		...
		?>	
				</br><center><div class='w3-col w3-pale-yellow w3-topbar w3-bottombar w3-border-yellow'><b><h3>Existing Users</h3></b></div></center>
					...
					<?php
						...
						$exist_users=mysql_query($userqry);
							while($exist=mysql_fetch_assoc($exist_users)){
								echo "<tr>";
								echo "<td>".$exist['userid']."</td>";
								echo "<td>".$exist['fullname']."</td>";
								echo "<td>".$exist['email']."</td>";
								echo "<td>".$exist['address']."</td>";
								echo "<td>".$exist['contactnum']."</td>";
								echo "<td>".$exist['username']."</td>";
								echo "<td>".$exist['password']."</td>";
								echo "<td><a href='delete_sfdetails.php?id=".$exist['userid']."'><button class='w3-button w3-circle w3-red fa fa-remove'></button></a></td>";
								echo "</tr>";
							}
					?>
				</table></br>
