<?php
		if(isset($_POST['signup'])){
			...
			$password2 = mysql_real_escape_string($_POST['psw_repeat']);
			
			if($password == $password2){
				$sql01 = "INSERT INTO users(fullname, email, address, contactnum, username, password) VALUES('".$fullname."', '".$email."', '".$address."', '".$contactnum."', '".$username."', '".$password."')";
				mysql_query($sql01);
				$_SESSION['msg'] = "You are now registered! Click here to <a href='Login.php'>login</a>.";
				$_SESSION['user'] = $username;
			}else{
				$_SESSION['msg'] = "Two passwords never match.";
				header("location: Register.php", true,  301 );  exit;
			}
...
<html>
    ...
    <body class="w3-khaki">
        <header class="w3-container w3-khaki" id="identify01"><img src="logoservice.png" style="height:150px;width:150px;" align="center">TRIPLE MMM Services</header>
