...
<html>
    ...
    <body class="w3-sand">
        ...
        <article class="w3-light">
			...
			?>	
				</br><center><div class='w3-col w3-pale-yellow w3-topbar w3-bottombar w3-border-yellow'><b><h3>View Vehicles and Drivers</h3></b></div></center>
				<div class="w3-container">
					<table class="w3-table w3-striped">
						...
						<?php
							$userqry="SELECT * FROM drivers";
							$exist_users=mysql_query($userqry);
								while($exist=mysql_fetch_assoc($exist_users)){
									echo "<tr>";
									echo "<td>".$exist['driver_id']."</td>";
									echo "<td>".$exist['driver_name']."</td>";
									echo "<td>".$exist['start_time']."</td>";
									echo "<td>".$exist['end_time']."</td>";
									echo "<td>".$exist['driver_address']."</td>";
									echo "<td>".$exist['plate_number']."</td>";
									echo "<td>".$exist['vehicle_type']."</td>";
									echo "<td><a href='delete_VDdata.php?id_data=".$exist['driver_id']."'><button class='w3-button w3-circle w3-red fa fa-remove'></button></a></td>";
									echo "<td><a href='update_VD.php?id_driver=".$exist['driver_id']."'><img src='edit.png' width='25px'></a></td>";
									echo "</tr>";
								}
						?>
					</table>
