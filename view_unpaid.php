...
<html>
    ...
    <body class="w3-sand">
		...
		?>	
				</br><center><div class='w3-col w3-pale-yellow w3-topbar w3-bottombar w3-border-yellow'><b><h3>View Unpaid Students</h3></b></div></center>
				<table class="w3-table w3-striped">
					...
					<?php
						$sql_15 = "SELECT * FROM students WHERE student_status='Unpaid'";
						...
						while($row_exist = mysql_fetch_assoc($exist_sql)){
							...
							echo "<td>"; 
							if($row_exist['if_verified_payment'] == "Verify"){
								echo "<a href='process_payment.php?Sid=".$row_exist['student_id']."'><button class='w3-button w3-blue w3-round'>Verify Client Payment</button></a>";
							}
							echo "</td>";
							echo "</tr>";
						}
